...
class ClientValidator:
    ...
    def validateCNP(CNP):
        ...
        control=int(CNP[0])*2+int(CNP[1])*7+int(CNP[2])*9+int(CNP[3])*1+int(CNP[4])*4+int(CNP[5])*6+int(CNP[6])*3+int(CNP[7])*5+int(CNP[8])*8+int(CNP[9])*2+int(CNP[10])*7+int(CNP[11])*9
