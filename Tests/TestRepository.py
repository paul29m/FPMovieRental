...
class TestRepository(unittest.TestCase):
    ...
    def testRemove(self):
        ...
        self.assertRaises(MovieException, self.repo.remove, 5)
        # No Error because it raises MovieException, 5 was already been removed
        self.assertRaises(MovieException, self.repo.remove, 6)
        # AssertionError because the client 6 exist in the repo and can be removed
